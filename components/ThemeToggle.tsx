...
export default function ThemeToggle() {
  ...
  // Don't render toggle position until we know the theme
  if (!mounted) {
    return (
      <button className="relative z-10" aria-label="Toggle theme">
        <div className="relative w-16 h-8 bg-gray-800 rounded-full p-1">
          <div className="absolute top-1 bottom-1 w-6 rounded-full bg-white" />
